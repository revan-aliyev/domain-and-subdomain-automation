...
def save_results_to_file(results, txt_filename="output.txt", csv_filename="output.csv"):
    # Save to TXT file
    ...
    with open(csv_filename, mode="w", newline="") as csv_file:
        ...
        writer.writerow(["Domain", "IP Address", "HTTP Status"])
        for domain, ip, status in results:
...
if __name__ == "__main__":
    ...
    # İstifadə ediləcək domen
    domain_name = args.domain

    # Subdomenləri təyin et
